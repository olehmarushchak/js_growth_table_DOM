...
addRowButton.addEventListener("click", ()=>{
    ...
    if (tableBody.rows.length === 10) return addRowButton.setAttribute("disabled", "");
    return removeRow.removeAttribute("disabled");
});
removeRow.addEventListener("click", ()=>{
    const lastRow = tableBody.rows[tableBody.rows.length - 1];
    tableBody.removeChild(lastRow);
    if (tableBody.rows.length === 2) return removeRow.setAttribute("disabled", "");
...
addColumn.addEventListener("click", ()=>{
    ...
    if (tdOfFirstRows.length === DISABLED_COLUMN_ADD) return addColumn.setAttribute("disabled", "");
...
removeColumn.addEventListener("click", ()=>{
    ...
    if (tdOfFirstRows.length === DISABLED_COLUMN_REMOVE) return removeColumn.setAttribute("disabled", "");
